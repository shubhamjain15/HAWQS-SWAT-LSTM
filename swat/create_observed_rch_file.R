create_observed_rch_file <- function(StationID,rch_id,start_date, end_date,start_date_obs, end_date_obs,project,hawqs_area, obj_func = 9, min_value = 0.5){
  flows <- readNWISdv(StationID, parameterCd = "00060", startDate = start_date_obs, endDate = end_date_obs)
