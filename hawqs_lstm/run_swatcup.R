run_swatcup <- function(project,inputs_folder,StationID,huc_id,start_date, end_date,obj_func = 9, min_value = 0.5, NYSKIP = 2,IPRINT = 1){
  ...
  create_observed_rch_file(StationID,rch_id,start_date, end_date,project, obj_func = obj_func, min_value = min_value)
